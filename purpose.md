...
* characterize each face, with the image, taken literally, as an anchor, but elaborating into the abstract or fanciful etc.
* lay out a set of basic narrative arcs - maybe just one!? maybe several. probably not more than that.
* either add to each characterization a focused interpretation of it as each part of an arc ("actor", "obstacle", "goal", "distraction", hmm there will be a lot of these) or, now that I'm detailing this, offer some examples of such an interpretation as a way of pointing towards a system that can be fleshed out as needed
